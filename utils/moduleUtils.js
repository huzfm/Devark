...
export const log = {
      ...
      bigSuccess: (msg) =>
            console.log(`\x1b[1m\x1b[92m${msg}\x1b[0m`),
...
export async function promptEnvCredentials(fields) {
      ...
      const vars = Object.fromEntries(Object.entries(answers).filter(([_, v]) => v && v.trim()));
      return vars;
}

/* ⚙️ Install dependencies (runtime + dev) */
export async function installDeps(targetPath, packageManager, lang, runtimeDeps, devDeps = []) {
